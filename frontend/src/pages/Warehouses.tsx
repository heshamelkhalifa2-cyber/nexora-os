...
export default function Warehouses() {
  ...
  return (
    <Layout>
      ...
      <p style={{ color: 'var(--color-text-muted)', marginTop: -8 }}>{t('warehouses.subtitle')}</p>
...
const styles: Record<string, React.CSSProperties> = {
  form: { display: 'flex', gap: 8, marginBottom: 12, background: 'var(--color-card)', padding: 16, borderRadius: 10 },
