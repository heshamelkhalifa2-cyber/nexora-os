...
const styles: Record<string, React.CSSProperties> = {
  ...
  subtitle: { margin: 0, textAlign: 'center', color: 'var(--color-text-muted)', marginBottom: 8 },
  input: { padding: '10px 12px', borderRadius: 8, background: 'var(--color-card)', color: 'var(--color-text)', border: '1px solid var(--color-border-strong)', fontSize: 14 },
  button: {
    padding: '10px 12px',
    borderRadius: 8,
    border: 'none',
  ...
  linkButton: { background: 'none', border: 'none', color: 'var(--color-primary)', cursor: 'pointer', fontSize: 13 },
